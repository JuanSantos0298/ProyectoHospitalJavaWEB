...
public class PruebaConexionBD {
    ...
    public static void main(String[] args) {
        try {
            ...
            String user = "Carlos Juan";
            int id = 10000;

            //Pruebas
            String SQL = "Select nombre from paciente where id_paciente = '"+id+"';";
            ...
            while(data.next()){
                System.out.println(data.getString("id_paciente") + " " + data.getString("nombre") + " " + data.getString("apellido_paterno") + " " + data.getString("apellido_materno") + " " + data.getString("direccion"));
            }
